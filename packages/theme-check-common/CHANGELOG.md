...
- 6803e99c: Port additional theme-check checks
...
- 180eacbe: Add `UnsupportedFilterArguments` check to error when a filter is used in `render`, `include`, and `content_for` tags.
